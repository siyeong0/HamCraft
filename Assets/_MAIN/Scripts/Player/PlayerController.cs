	...
	public class Player : MonoBehaviour
	{
		...
		void Update()
		{
			...
			if (Input.GetMouseButton(0)) // front layer
			{
				...
				{
					case 0: // 부수기
						World.RemoveBlockAt(mouseWorldPos, ETerrainLayer.Front);
						break;
					case 1: // 설치하기
						World.AddBlockAt(1, mouseWorldPos, ETerrainLayer.Front);
						break;
				}
			}
			else if (Input.GetMouseButton(1)) // back layer
			{
				...
				{
					case 0: // 부수기
						World.RemoveBlockAt(mouseWorldPos, ETerrainLayer.Back);
						break;
					case 1: // 설치하기
						World.AddBlockAt(1, mouseWorldPos, ETerrainLayer.Back);
						break;
				}
			}
